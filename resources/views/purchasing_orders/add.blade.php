...
<div class="page-content">
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12">
            <form action="{{ route('purchasing_orders.store') }}" method="post">
               @csrf
               <div class="card">
                  <div class="card-header">
                     <div class="row">
                        <div class="col-5">
                           <h4 class="card-title">Add Purchasing Order</h4>
                        </div>
                        ...
                        <div class="col-2 text-right">
                           ...
                           <a href="{{ route('purchasing_orders.index') }}" class="btn btn-warning btn-md" title="Back">
